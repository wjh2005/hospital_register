 ...
 * @param state The state that uses the specified dateTitle. The values are described in UIControlState.
 */
 ...
 * @param url The url for the image.
 * @param state The state that uses the specified dateTitle. The values are described in UIControlState.
 * @param completedBlock A block called when operation has been completed. This block as no return weekDayValue
 ...
 *   completed. This block has no return weekDayValue and takes three argument: the requested
